...
//linenum ,typeid...
int test_call(long counter,int* intArray,int intTail,double* doubleArray, int doubleTail, float* floatArray, int floatTail,long* longArray, int longTail, char* charArray, int charTail,char* byteArray,int byteTail)
{
	int re=999;
...
printf("result1==%d\n",test_call(1,NULL,0,a1,10,NULL,0,NULL,0,NULL,0,NULL,0));

double a11[]={1.0,2.0,2.0,4.0,5.0,6.0,7.0,8.0,9.0,0.0};
printf("result2==%d\n",test_call(1,NULL,0,a11,10,NULL,0,NULL,0,NULL,0,NULL,0));
destroy_enclave();
/*
